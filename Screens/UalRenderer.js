...
//   return `${quantity} ${symbol}`
// }
// const handleHome =(a,navigate)=>{
//   //console.log(props.ual.logout)
//   a.logout 
...
class TestApp extends Component {
  ...
  renderLoggedInView = () => (
    <>
      ...
      {/* <TouchableOpacity type='button' onPress={this.props.ual.logout } style={styles.logout}>
        <p>Logout</p>
      </TouchableOpacity> */}
      <TouchableOpacity type='button' onPress={this.props.ual.logout} style={styles.logout}>
        <p>logout</p>
    ...
    return (
      <div style={styles.container}>
        ...
        <UALProvider
          ...
          key={chain.chainId}
        >
          <TestAppConsumer navigation={navigation} />
        </UALProvider>
      </div>
    )
  }
...
const UalRenderer = ({navigation}) => (
  <>
  <UALWrapper available={chains} navigation={navigation}/>
